...
import * as FBX from 'three-fbx-loader'
@Component({
...
export class PanoramaEquirectangularComponent implements AfterViewInit {
  ...
  @Input()
  public texture: string = '/assets/textures/Office-Refurb-2.jpg';
  ...
  private createPanorama() {
    ...
    // let loader = new FBX.FBXLoader();
    //  loader.load(this.texture, function (geometry) {
